...
public class e6 : e3
{
  public static readonly string bc = "resourcegatheringbuffovertime";
  ...
  public override bool cj(XmlElement A_0)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    this.h3(aim.a<e6.ResourceGatheringBuffTypes>(A_0, "bufftype", e6.ResourceGatheringBuffTypes.GatheringYield));
    return base.cj(A_0);
  }
  ...
  protected override string ck(er.a A_0)
  {
    switch (A_0.a)
    {
      case "resourcetype":
        // ISSUE: reference to a compiler-generated method
        // ISSUE: reference to a compiler-generated method
        return kr.b("@ITEMS_T" + (object) this.h4() + "_" + this.h3());
      case "tier":
        // ISSUE: reference to a compiler-generated method
        return this.h4().ToString();
      case "value":
        // ISSUE: reference to a compiler-generated method
        return er.h3(this.h6());
      default:
        return base.ck(A_0);
    }
  }
