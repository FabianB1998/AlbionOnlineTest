...
{
  [SpecialName]
  public override global::s.MissionType au()
  {
    return global::s.MissionType.FarmRaiseFame;
  }
  ...
  public override global::s av(Dictionary<string, ci.a> A_0, ah6 A_1)
  {
    aa aa = new aa();
    // ISSUE: reference to a compiler-generated method
    // ISSUE: reference to a compiler-generated method
        ...
        if (A_0 != null && A_0.an() != null)
        {
          ...
          else
          {
            ...
            for (int index = 0; index < 4; ++index)
            {
              ...
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              if (c7 != null && c7.ea() != null && c7.ea().l().i() > 0L)
              {
                flag2 = true;
                break;
              }
            ...
            {
              if (A_1 != null)
                A_1.Add(A_0_1 + " gives no Fame on Raising!");
              flag1 = true;
            }
          }
        }
